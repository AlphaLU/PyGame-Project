...
pygame.display.set_caption('Snake Alpha 0.1')
...
def message_to_screen(msg, color):
	screen_test = font.render(msg, True, color)
	gameDisplay.blit(screen_test, [display_width/3, display_height/2])
...
def gameLoop():
	...
	#Generate apple at random coordinates X & Y
